...
const cases: [string, { safeParse(value: unknown): { success: boolean } }, unknown][] = [
  ...
  ['RawCallObservation', domain.RawCallObservationSchema, samples.sampleRawCallObservation],
  ['UsageRecord', domain.UsageRecordSchema, samples.sampleUsageRecord],
  ['QuotaObservation', domain.QuotaObservationSchema, samples.sampleQuotaObservation],
